...
public class TestCases extends VietJetTestBase {
	...
	public void TC01() throws Exception {
		...
		//1. Navigate to 'https://www.vietjetair.com/Sites/Web/en-US/Home'.
		Logger.info("1. Navigate to 'https://www.vietjetair.com/Sites/Web/en-US/Home'.");
		launchApp();
		
		//2. Search the ticket with the following information
		...
		//3. Choose the cheapest tickets and click 'Continue' button
